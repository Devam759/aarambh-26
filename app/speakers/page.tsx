...
const SPEAKERS_DATA = [
  {
    ...
    bio: "Meet Ms. Anjali Suneja, a nationally recognized HR leader, Ministry-empanelled POSH & POCSO Consultant, and award-winning social impact professional with over 15 years of experience in building safe, inclusive, and people -centric workplaces. As the Co-Founder and Director-HR at HiveSure InfoSolutions and an External POSH Committee Member for 25+ organizations, she has trained and impacted 18000+ professionals and students, helping organizations foster cultures of respect, trust, and accountability. Known for her relatable style, practical insights, and people-first approach, Anjali goes beyond policies and procedures to spark meaningful conversations and lasting change. Her mission is simple: to help organizations create workplaces where everyone can thrive with confidence, respect, and a sense of belonging.",
  ...
  },
  {
    ...
    bio: "Kunal Agarwal is a Craft Product Designer, Ceramic Manufacturer, and Founder of Kunal Pottery Studio, Jaipur. With expertise in design, craft, and tradition, he combines heritage craftsmanship with contemporary design thinking to create unique ceramic products and immersive learning experiences. Passionate about innovation through making, Mr. Kunal inspires individuals to explore creativity, craftsmanship, and the art of transforming simple materials into meaningful creations.",
  ...
  },
  {
    ...
    bio: "Manish Freeman is a movement facilitator who transforms dance and play into meaningful human connection. Through his energetic and interactive approach, he creates spaces where people can express themselves freely, build confidence, and connect with others. At Aarambh ’26, Manish brings rhythm, joy, and presence to help freshers break the ice, form authentic bonds, and begin their college journey with enthusiasm and a sense of belonging.",
  ...
  },
  {
    ...
    bio: "Mukesh Choudhary is a Cyber Crime Consultant and Information Security Professional with over a decade of experience in the field of cyber security and digital awareness. He has trained some of India's leading law enforcement and intelligence agencies, including the CBI and the armed forces, equipping them with critical knowledge in cyber crime prevention, investigation, and information security.",
  ...
  },
  {
    ...
    role: 'IIT alumnus, tech co-founder, and bestselling author',
    time: "Aarambh '26 · JKLU",
    image: 'https://storage.googleapis.com/aarambh-26-assets/images/speakers/RamG%20Vallath.webp',
    bio: "IIT alumnus, tech co-founder, and bestselling author Ram G Vallath is widely recognized as one of the most inspiring mindset architects of our time. After a critical illness paused his executive trajectory, he pioneered his own recovery using a high-risk medical treatment and intense physical conditioning. Today, he is a powerhouse TEDx speaker and Growth Mindset Coach on a mission to hardwire resilience, neuroplasticity, and deep-rooted happiness into millions of young minds and corporate leaders worldwide.",
  ...
  },
  {
    ...
    bio: "Vibhuti Mehra is a mindfulness coach, dedicated to helping young minds build resilience, manage stress, and lead balanced lives. With experience spanning leadership roles in the UK education sector and a background as a state-level swimmer, she brings a unique blend of discipline, mindfulness, and personal development to her sessions. Having worked with students from leading institutions across India, she inspires youth to unlock their potential through inner strength and self-awareness.",
    expertise: ['Meditation & Breathwork', 'Stress Management', 'Holistic Wellness'],
    linkedin: 'https://www.linkedin.com/in/vibhuti-mehra/',
  },
  {
    name: 'Manan Pahwa',
    role: 'Designer, Certified Hypnotherapist  & Behavior Researcher',
    time: "Aarambh '26 · JKLU",
    image: 'https://storage.googleapis.com/aarambh-26-assets/images/speakers/Manan%20Pahwa%20.webp',
    bio: "Manan Pahwa is an acclaimed Applied Behavioural Researcher, Strategic Designer, and Certified Hypnotherapist with over 5 years of cross-disciplinary experience decoding human decision-making across complex digital and physical ecosystems. An alumnus of the National Institute of Design (NID), Ahmedabad, with international training at the Willem de Kooning Academy in the Netherlands, he masterfully blends consumer psychology, material innovation, and UX architecture to build highly intuitive products. Throughout a versatile career spanning key roles at Tata Digital, BIAS, and Delhivery-where his team clinched the Best Original Research Paper award in 2023-Manan has pioneered user- centric strategies that bridge the gap between human instinct and business scale. Currently driving venture-building capabilities as a Human Behaviour Strategist at 2070 Health, he remains a prominent industry voice dedicated to keeping technology deeply grounded in authentic human experiences.",
